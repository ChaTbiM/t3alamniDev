    ...
    <nav class="nav">
        <div class="nav__top">
            <ul class="nav__top__left">
                ...
                <li class="nav__list__item"><a href="#" class="nav__list__item__link top__link plus__link">Plus <span class="arrow">
                    <img src="arrow-down-solid.svg" alt="plus" class="plus__img"> </span></a></li>
            </ul>
            <div class="nav__top__right">
                    ...
                    <li class="avatar"><a href="" class="avatar__link">
                            <img src="man.svg" alt="avatar" class="avatar__img">   
        ...
        <div class="nav__bottom">
            <ul class="nav__bottom__list">
                <li class="nav__list__item"> <a href="#" class="nav__list__item__link bottom__link">Schedule</a> </li>
                <li class="nav__list__item"> <a href="#" class="nav__list__item__link bottom__link">Groupes</a> </li>
